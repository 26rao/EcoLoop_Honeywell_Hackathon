...
def run_real_energyplus_baseline():
    print("==================================================")
    print("EcoLoop Phase 1 — REAL EnergyPlus Closed-Loop Baseline Execution")
    print("==================================================")
    ...
    def callback_function(s):
        ...
        # Skip warmup days so decisions map 1:1 to the 72-hour RunPeriod
    ...
    print("Executing real EnergyPlus simulation run...")
    ...
    print(f"\nReal EnergyPlus Phase 1 Run Complete!")
    print(f"- Exit Code: {exit_code}")
    print(f"- Decisions Logged: {len(records)}")
    print(f"- Output directory: logs/real_ep_out")
    print(f"- Real handles verified: {handles}")

if __name__ == "__main__":
    run_real_energyplus_baseline()
